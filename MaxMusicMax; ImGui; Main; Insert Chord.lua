		...
		elseif selected_content == "Insert_Empty_Item_Chord_Content_Show" then
			...
			local insert_empty_item_chord_library = {
				key = "Insert Empty Item Chord", default_open = true, children = {
					...
					{key = "Insert Empty Item Chord", default_open = true, children = {
						{key = chord_qzzmsbnelc .. "", action_function = function() InsertEmptyItemWithNameAndColor( chord_qzzmsbnelc .. "", color_item, note_item_length_value_qzzmsbnelc) end},
						{key = chord_qzzmsbnelc .. "6", action_function = function() InsertEmptyItemWithNameAndColor(chord_qzzmsbnelc .. "6", color_item, note_item_length_value_qzzmsbnelc) end},
						{key = chord_qzzmsbnelc .. "maj", action_function = function() InsertEmptyItemWithNameAndColor(chord_qzzmsbnelc .. "∆", color_item, note_item_length_value_qzzmsbnelc) end},
						{key = chord_qzzmsbnelc .. "maj (6/9)", action_function = function() InsertEmptyItemWithNameAndColor(chord_qzzmsbnelc .. "∆ (6/9)", color_item, note_item_length_value_qzzmsbnelc) end},
						{key = chord_qzzmsbnelc .. "maj (13#11)", action_function = function() InsertEmptyItemWithNameAndColor(chord_qzzmsbnelc .. "∆ (13#11)", color_item, note_item_length_value_qzzmsbnelc) end},
						{key = chord_qzzmsbnelc .. "maj (7#5)", action_function = function() InsertEmptyItemWithNameAndColor(chord_qzzmsbnelc .. "∆ (7#5)", color_item, note_item_length_value_qzzmsbnelc) end},
						{spacing_vertical = "0"},
						{separator_horizontal = "3", separator_color = "#3F3F48", separator_length = 120 },
						{spacing_vertical = "5"},
						
						{key = chord_qzzmsbnelc .. "7", action_function = function() InsertEmptyItemWithNameAndColor(chord_qzzmsbnelc .. "7", color_item, note_item_length_value_qzzmsbnelc) end},
						{key = chord_qzzmsbnelc .. "7(6b9)", action_function = function() InsertEmptyItemWithNameAndColor(chord_qzzmsbnelc .. "7(6b9)", color_item, note_item_length_value_qzzmsbnelc) end},
						{key = chord_qzzmsbnelc .. "7(9,11,13)", action_function = function() InsertEmptyItemWithNameAndColor(chord_qzzmsbnelc .. "7(9,11,13)", color_item, note_item_length_value_qzzmsbnelc) end},
						{key = chord_qzzmsbnelc .. "7 (13#11)", action_function = function() InsertEmptyItemWithNameAndColor(chord_qzzmsbnelc .. "7 (13#11)", color_item, note_item_length_value_qzzmsbnelc) end},
						{key = chord_qzzmsbnelc .. "7 (#9b13)", action_function = function() InsertEmptyItemWithNameAndColor(chord_qzzmsbnelc .. "7 (#9b13)", color_item, note_item_length_value_qzzmsbnelc) end},
						{key = chord_qzzmsbnelc .. "7 (b9#9b13)", action_function = function() InsertEmptyItemWithNameAndColor(chord_qzzmsbnelc .. "7 (b9#9b13)", color_item, note_item_length_value_qzzmsbnelc) end},
						{key = chord_qzzmsbnelc .. "9", action_function = function() InsertEmptyItemWithNameAndColor(chord_qzzmsbnelc .. "9", color_item, note_item_length_value_qzzmsbnelc) end},
						{spacing_vertical = "0"},
						{separator_horizontal = "3", separator_color = "#3F3F48", separator_length = 120 },
						{spacing_vertical = "5"},
						
						{key = chord_qzzmsbnelc .. "sus2", action_function = function() InsertEmptyItemWithNameAndColor(chord_qzzmsbnelc .. "sus2", color_item, note_item_length_value_qzzmsbnelc) end},
						{key = chord_qzzmsbnelc .. "sus4", action_function = function() InsertEmptyItemWithNameAndColor(chord_qzzmsbnelc .. "sus4", color_item, note_item_length_value_qzzmsbnelc) end},
						{key = chord_qzzmsbnelc .. "7sus4", action_function = function() InsertEmptyItemWithNameAndColor(chord_qzzmsbnelc .. "7sus4", color_item, note_item_length_value_qzzmsbnelc) end},
						{key = chord_qzzmsbnelc .. "9sus4", action_function = function() InsertEmptyItemWithNameAndColor(chord_qzzmsbnelc .. "9sus4", color_item, note_item_length_value_qzzmsbnelc) end},
						{key = chord_qzzmsbnelc .. "13sus4", action_function = function() InsertEmptyItemWithNameAndColor(chord_qzzmsbnelc .. "13sus4", color_item, note_item_length_value_qzzmsbnelc) end},
						{spacing_vertical = "0"},
						{separator_horizontal = "3", separator_color = "#3F3F48", separator_length = 120 },
						{spacing_vertical = "5"},
						
						{key = chord_qzzmsbnelc .. "m", action_function = function() InsertEmptyItemWithNameAndColor(chord_qzzmsbnelc .. "m", color_item, note_item_length_value_qzzmsbnelc) end},
						{key = chord_qzzmsbnelc .. "m6", action_function = function() InsertEmptyItemWithNameAndColor(chord_qzzmsbnelc .. "m6", color_item, note_item_length_value_qzzmsbnelc) end},
						{key = chord_qzzmsbnelc .. "m (6/9)", action_function = function() InsertEmptyItemWithNameAndColor(chord_qzzmsbnelc .. "m (6/9)", color_item, note_item_length_value_qzzmsbnelc) end},
						{key = chord_qzzmsbnelc .. "m7", action_function = function() InsertEmptyItemWithNameAndColor(chord_qzzmsbnelc .. "m7", color_item, note_item_length_value_qzzmsbnelc) end},
						{key = chord_qzzmsbnelc .. "m9", action_function = function() InsertEmptyItemWithNameAndColor(chord_qzzmsbnelc .. "m9", color_item, note_item_length_value_qzzmsbnelc) end},
						{key = chord_qzzmsbnelc .. "m (maj11)", action_function = function() InsertEmptyItemWithNameAndColor(chord_qzzmsbnelc .. "m (maj11)", color_item, note_item_length_value_qzzmsbnelc) end},
						{key = chord_qzzmsbnelc .. "m (9b13)", action_function = function() InsertEmptyItemWithNameAndColor(chord_qzzmsbnelc .. "m (9b13)", color_item, note_item_length_value_qzzmsbnelc) end},
						{spacing_vertical = "0"},
						{separator_horizontal = "3", separator_color = "#3F3F48", separator_length = 120 },
						{spacing_vertical = "5"},
						
						{key = chord_qzzmsbnelc .. "ø", action_function = function() InsertEmptyItemWithNameAndColor(chord_qzzmsbnelc .. "ø", color_item, note_item_length_value_qzzmsbnelc) end},
						{key = chord_qzzmsbnelc .. "o", action_function = function() InsertEmptyItemWithNameAndColor(chord_qzzmsbnelc .. "o", color_item, note_item_length_value_qzzmsbnelc) end},
						{key = chord_qzzmsbnelc .. "+", action_function = function() InsertEmptyItemWithNameAndColor(chord_qzzmsbnelc .. "+", color_item, note_item_length_value_qzzmsbnelc) end},
						{spacing_vertical = "10"},
					},},
				},
